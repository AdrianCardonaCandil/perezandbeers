...
const Layout = () => {
    return (
        <div className="min-h-screen text-sm md:text-base lg:text-lg bg-[var(--surface-light)] font-['Raleway'] text-[var(--on-surface-light)] dark:bg-[var(--surface-dark)] dark:text-[var(--on-surface-dark)]">
